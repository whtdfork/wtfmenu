...
window.SITE_CONFIG = {
  ...
  values: [
    ...
    ["🍕", "Made to order", "Your food is freshly prepared when you order it."],
    ["🌿", "100% vegetarian", "Wholesome vegetarian food for every kind of craving."],
  ...
  gallery: [
    ["images/margherita.png", "Fresh pizza"],
